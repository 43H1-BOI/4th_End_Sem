...
| :--- | :------------------- | :----------------------------------------------- | :------------- |
| `-`  | Ordinary File        | Contains data, text, or program code.          | [Notes] Pg 9; [TP] Pg 18, 16 |
| `d`  | Directory            | Contains other files and directories.            | [Notes] Pg 9; [TP] Pg 18, 16 |
...
*   **Symbolic Mode:** Uses `u, g, o, a` and `+, -, =` with `r, w, x`.
    ...
    *(Source: [Notes] Pg 38; [TP] Pg 21, 31)*
...
*(Source: [Notes] Pg 39; [TP] Pg 12, 21)*
...
*(Source: [Notes] Pg 20; [TP] Pg 37, 47)*
...
*(Source: [Notes] Pg 19; [TP] Pg 23, 121)*

**Operators:**
*   `< file`: Redirect standard input from `file`. *(Source: [TP] Pg 122)*
*   `> file`: Redirect standard output to `file` (overwrites). *(Source: [TP] Pg 121)*
*   `>> file`: Redirect standard output to `file` (appends). *(Source: [TP] Pg 121)*
*   `2> file`: Redirect standard error (fd 2) to `file`. *(Source: [TP] Pg 125)*
*   `&> file` or `> file 2>&1`: Redirect both stdout and stderr to `file`. *(Source: [TP] Pg 125)*
*   `<< DELIMITER`: "Here Document". Redirects lines following the command (until `DELIMITER`) as stdin. *(Source: [TP] Pg 122)*

### 16. `grep` Command

**Purpose:** Searches input for lines matching a pattern (regular expression).
*(Source: [Notes] Pg 41; [TP] Pg 37, 47)*
...
*   **`head`**: Display first N lines (default 10). Option `-n N` or `-N`. *(Source: [Notes] Pg 38; [TP] Pg 59 - mentioned in context)*
*   **`tail`**: Display last N lines (default 10). Option `-n N` or `-N`. Option `-f` to follow file changes. *(Source: [Notes] Pg 39; [TP] Pg 59 - mentioned in context)*

### 18. `sort` Command

**Purpose:** Sorts lines of text.
*(Source: [Notes] Pg 40; [TP] Pg 38, 49)*
...
*   **Process:** A running instance of a program, with its own PID, memory space, and resources. *(Source: [Notes] Pg 27; [TP] Pg 41, 51)*
*   **Parent/Child:** A process that creates another (`fork()`) is the parent; the new one is the child. *(Source: [Notes] Pg 27; [TP] Pg 44, 55)*
*   **Zombie:** A terminated process whose parent hasn't read its exit status yet; shown as `<defunct>` or `Z`. *(Source: [Notes] Pg 29; [TP] Pg 44, 55)*
*   **Orphan:** A process whose parent terminated; adopted by `init` (PID 1). *(Source: [TP] Pg 44, 55)*
*   **Daemon:** A system background process, no controlling terminal (`tty` is `?`), often runs as root, provides services. *(Source: [Notes] Pg 32; [TP] Pg 45, 55)*

### 21. Process Creation & Management

**Creation:** Typically via `fork()` (create copy) followed by `exec()` (replace program image). *(Source: [Notes] Pg 30; [TP] Pg 44 - concept, calls not named)*
...
*   **Foreground:** Runs interactively, attached to terminal, shell waits. Default execution. *(Source: [Notes] Pg 31; [TP] Pg 41, 52)*
*   **Background:** Runs detached from terminal, shell returns prompt immediately. Started with `&`. *(Source: [Notes] Pg 31; [TP] Pg 42, 52)*

### 23. Process Status (`ps`) Command

**Purpose:** Display information about active processes.
*(Source: [Notes] Pg 30; [TP] Pg 42, 53)*
...
*(Source: [Notes] Pg 34; [TP] Pg 44, 54)*
...
*   **Shell:** Command-line interpreter, interface to kernel. *(Source: [Notes] Pg 3, 47; [TP] Pg 10, 64)*
*   **Types:** `sh`, `bash` (common Linux default), `csh`, `ksh`, `tcsh`. *(Source: [Notes] Pg 4, 47; [TP] Pg 11, 64)*
*   **Prompt:** PS1 (primary, e.g., `$`), PS2 (secondary, e.g., `>`). *(Source: [Notes] Pg 50; [TP] Pg 28, 38, 64)*
*   **Comments:** `#` denotes a comment (except for `#!` shebang). *(Source: [Notes] Pg 49; [TP] Pg 66)*

### 27. Shell Scripts

*   **Definition:** Text file with shell commands, executed sequentially. *(Source: [Notes] Pg 48; [TP] Pg 65)*
...
*   **Environment Vars:** System/Shell defined, UPPERCASE convention, inherited. `HOME`, `PATH`, `USER`, `PS1`, `TERM`. *(Source: [Notes] Pg 50; [TP] Pg 30, 41, 68)*
...
*(Source: [Notes] Pg 53-55; [TP] Pg 77-93)*
...
*(Source: [Notes] Pg 56-60; [TP] Pg 94-112)*
*   **`if` Statements:**
    *   `if [ cond ]; then ... fi`
...
*   **Metacharacters (Globbing):** `*` (0+ chars), `?` (1 char), `[...]` (any char in set). For filename expansion. *(Source: [Notes] Pg 9-metachar context; [TP] Pg 10, 19, 117)*
*   **Quoting:**
...
*(Source: [TP] Pg 118-120)*

### 33. Unix Environment

*   **Concept:** Set of variables defining user session settings. *(Source: [TP] Pg 26, 37)*
*   **Initialization:** `/etc/profile` (system-wide), `~/.profile` (user-specific) read at login (for Bourne-type shells). *(Source: [TP] Pg 27, 37)*
*   **`PATH` Variable:** Colon-separated list of directories searched for commands. View with `echo $PATH`. Set with `export PATH="$PATH:/new/path"`. *(Source: [Notes] Pg 50; [TP] Pg 27, 38, 41)*
...
*(Source: [Notes] Pg 20-21 - basic creation/edit; [TP] Pg 52-62 - detailed)*
*   **Modes:**
